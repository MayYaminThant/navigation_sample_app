...
class StarList extends Equatable {
  ...
  const StarList({this.id, this.ofUserId, this.onUserId, this.starAddDateTime, this.starDisplayOrder, this.employer});

  @override
  List<Object?> get props => [id, ofUserId, onUserId, starAddDateTime, starDisplayOrder, employer];
