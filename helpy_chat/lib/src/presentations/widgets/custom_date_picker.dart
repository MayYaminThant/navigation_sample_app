...
class _CustomDatePickerState extends State<CustomDatePicker> {
      ...
      child: Padding(
        ...
        child: Theme(
          ...
          child: DateTimePicker(
            ...
            style: TextStyle(
                fontSize: 14, color: widget.textColor ?? AppColors.primaryGrey),
  ...
  DateTime _getFirstDate() =>
      widget.isShowPreviousDate! ? DateTime(1900) : DateTime.now();

  String getMonthYearFormatDate(DateTime date) =>
