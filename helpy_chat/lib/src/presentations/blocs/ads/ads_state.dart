...
class AdsCountLoading extends AdsState {}
...
class AdsCountSuccess extends AdsState {
  final DataResponseModel data;

  const AdsCountSuccess({required this.data});
...
class AdsCountFail extends AdsState {
  final String message;
  const AdsCountFail({required this.message});
}
