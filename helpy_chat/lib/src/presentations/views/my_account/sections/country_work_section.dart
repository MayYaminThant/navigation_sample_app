...
class _CountryWorkSectionState extends State<CountryWorkSection> {
        ...
        children: [
          Padding(
            ...
            child: _getCountryAndName(
                country ?? '', 'Select The Country You Like to Work In'.tr, 16,
  ...
  _getCountryAndName(String flag, String name, double fontSize,
      {Color? fontColor}) {
    return Row(
      children: [
        flag != 'Others'
        ...
        Expanded(
          child: Text(
            ...
            style: TextStyle(
                ...
                fontWeight:
                    fontColor != null ? FontWeight.w700 : FontWeight.normal),
          ),
        ),
      ],
    );
