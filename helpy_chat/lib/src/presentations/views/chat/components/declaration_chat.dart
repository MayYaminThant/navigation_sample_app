...
class _DeclarationRequestModalState extends State<DeclarationRequestModal> {
  ...
  Widget get _getDeclarationNo1 => const Text.rich(TextSpan(
        children: [
          TextSpan(
            text: '1) Change your ',
  ...
  Widget get _getDeclarationNo2 => const Text.rich(TextSpan(
        children: [
          TextSpan(
            text:
  ...
  Widget get _getDeclarationNo3 => const Text.rich(TextSpan(
        children: [
          TextSpan(
  ...
  Widget get _getDeclarationNo4 => const Text.rich(TextSpan(
        children: [
          TextSpan(
  ...
  Widget get _getDeclarationNo5 => const Text.rich(TextSpan(
        children: [
          TextSpan(
            text: '5) Give ',
            style: TextStyle(color: AppColors.primaryGrey, fontSize: 12),
  ...
  Widget get _getDeclarationNo6 => const Text.rich(TextSpan(
        children: [
          TextSpan(
            text: '6) Last of all! ',
            style: TextStyle(color: AppColors.primaryGrey, fontSize: 12),
