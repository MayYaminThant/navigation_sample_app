...
import 'package:dh_mobile/src/presentations/views/setting/components/custom_modal_change_password.dart';
...
class _CustomExpansionTileState extends State<CustomExpansionTile> {
    ...
    return GestureDetector(
      ...
      child: Column(
        children: [
          ...
          _buildTitleRow(),
          SizedBox(height: _isExpanded ? 24 : 10,),
  ...
  List<Widget> _buildExpandedContent() {
    return [
      ...
      _buildExpansionItem('Change Phone Number', widget.phoneNumber ?? '', false),
      GestureDetector(
        onTap: () {
          showDialog(
              context: context,
        ...
        child: _buildExpansionItem('Change Password', widget.changePassword ?? '', true)),
    ];
  }
