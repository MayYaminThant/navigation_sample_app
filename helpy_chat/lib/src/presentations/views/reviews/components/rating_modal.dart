...
class _RatingCreateModalState extends State<RatingCreateModal> {
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(
                  StringConst.createReviewTitle.tr,
                ...
                Text(
                  StringConst.selectRatingText.tr,
                  style: const TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.w400,
                      color: AppColors.greyShade2),
                ...
                const SizedBox(height: 10),
                Text(
                  StringConst.writeReviewText.tr,
                  style: const TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.w400,
                      color: AppColors.greyShade2),
                ),
                _getTextField(reviewController, StringConst.createReviewTitle.tr,
                    false, 4, AppColors.white),
                const SizedBox(height: 10),
                const SizedBox(height: 20),
                CustomPrimaryButton(
                  text: StringConst.submitReviewText.tr,
                  fontSize: 16,
  ...
  void _createCandidateReview() {
    ...
    candidateBloc.add(CandidateCreateReviewRequested(params: params));
  }
}
