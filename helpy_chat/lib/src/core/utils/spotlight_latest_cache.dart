...
class SpotlightLatestCache {
  ...
  List<Employer> generateLatestDisplayProfiles(List<Employer> allProfiles) {
    _initialiseAndRefresh(allProfiles);
    return _generateSubsetProfiles();
  }

  List<Employer> _generateSubsetProfiles() {
  ...
  void _initialiseAndRefresh(List<Employer> newProfiles) {
    _lastRefresh ??= _now;
    if (_cacheProfiles == null ||
  ...
  void _refreshCache(List<Employer> newProfiles) {
