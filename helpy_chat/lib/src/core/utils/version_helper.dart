...
class VersionHelper {
  ...
  static Future<bool> configEnvironmentChanged() async {
    try{
      ...
      final configRetrievalEnvironmentString = await getConfigRetrievalEnvironment();
  ...
  static Future<AppVersion> getMinimumCompatibleVersion() async {
    final minCompatibleVersionString = await DBUtils.getCandidateConfigs(
        ConfigsKeyHelper.candidateAppMinCompatibleVersionKey) as String;
