...
class SavedSearchModel extends SavedSearch {
  ...
  factory SavedSearchModel.fromJson(Map<dynamic, dynamic> map) {
    return SavedSearchModel(
        id: map['saved_search_id'] != null
            ? map['saved_search_id'] as int
            : null,
        ...
        currency: map['saved_search_data']['currency'] != null
            ...
            : null,
        expectedSalary: map['saved_search_data']['expected_salary'] != null
            ? int.parse(map['saved_search_data']['expected_salary'].toString())
            : null,
        ...
        skillSpecialNeedsCare:
            map['saved_search_data']['skill_special_needs_care'] != null
                ? int.parse(map['saved_search_data']['skill_special_needs_care']) ==
                    1
                : null,
        ...
        skillGeneralHousework:
            map['saved_search_data']['skill_general_housework'] != null
                ? int.parse(map['saved_search_data']['skill_general_housework']) ==
                    1
                : null,
        ...
        skillOthersSpecify: map['saved_search_data']['skill_others_specify'] != null
            ...
            : null,
        restDayChoice: map['saved_search_data']['rest_day_per_month_choice'] != null
            ? int.parse(map['saved_search_data']['rest_day_per_month_choice'].toString())
            : null,
        workRestDays: map['saved_search_data']['work_on_rest_day'] != null
            ? int.parse(map['saved_search_data']['work_on_rest_day'].toString()) != 0
                ? true
                : false
            : null,
        showOnlyEntriesWithPics: map['saved_search_data']['show_only_entries_with_pics'] != null
            ? int.parse(map['saved_search_data']['show_only_entries_with_pics'].toString()) != 0
                ? true
                : false
            : null,
        createdAt: map['saved_search_creation_datetime'] != null ? map['saved_search_creation_datetime'] as String : null,
        displayOrder: map['saved_search_display_order'] != null ? map['saved_search_display_order'] as int : null,
        saveMySearch: map['saved_search_data']['save_my_search'] != null
            ? int.parse(map['saved_search_data']['save_my_search'].toString()) != 0
                ? true
                : false
            : null,
        religion: map['saved_search_data']['employer_religion'] != null ? map['saved_search_data']['employer_religion'] as String : null);
  }
  ...
  factory SavedSearchModel.fromSavedJson(Map<dynamic, dynamic> map) {
    return SavedSearchModel(
        ...
        expectedSalary: map['expected_salary'] != null
            ? int.parse(map['expected_salary'].toString())
            : null,
        ...
        skillOthersSpecify: map['skill_others_specify'] != null
            ...
            : null,
        restDayChoice: map['rest_day_per_month_choice'] != null
            ? int.parse(map['rest_day_per_month_choice'].toString())
            : null,
        workRestDays: map['work_on_rest_day'] != null
            ? map['work_on_rest_day'] as bool
            : null,
        showOnlyEntriesWithPics: map['show_only_entries_with_pics'] != null
        ...
        saveMySearch: map['save_my_search'] != null
            ...
            : null,
        religion: map['employer_religion'] != null
            ? map['employer_religion'] as String
            : null);
  }
}
