...
class _NotificationSectionState extends State<NotificationSection> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<NotificationBloc, NotificationState>(
      ...
      return BackgroundScaffold(
          onWillPop: () => Get.offNamed(rootRoute),
          scaffold: isLoading
  ...
  Widget get _getEmptyNotification => EmptyMessage(
      ...
      onSelected: (String value) {
        switch (value) {
          ...
          case 'No Notification':
            showDialog(
                context: context,
                builder: (context) => const ErrorPopUpNotification(
                    title: 'There is no Notifications... yet!', subTitle: ''));
            break;
          default:
            break;
        }
