...
class _DeclarationModalState extends State<DeclarationModal> {
  ...
  Widget _getDeclarationCheckBox(String title, setState) =>
  ...
  Widget _getTermsAndEULA(setState) => TermsAndConditionsCheckBox(
        checkBoxColor: AppColors.primaryGrey.withOpacity(0.8),
        onValueChanged: (bool value) {
  ...
  Widget get _getTermsOfService => Text.rich(
        TextSpan(
          children: [
            const TextSpan(
