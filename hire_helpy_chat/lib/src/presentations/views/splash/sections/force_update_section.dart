...
import 'package:dh_employer/src/core/utils/version_helper.dart';
import 'package:dh_employer/src/presentations/values/values.dart';
import 'package:dh_employer/src/presentations/widgets/background_scaffold.dart';
        ...
        child: Column(
          ...
          children: [
            const SizedBox(
                ...
                width: 287,
                child: Image(
                    image: AssetImage('assets/images/update_required.png'))),
            const Spacer(
              flex: 1,
            ),
            Text(
