...
class AcademicQualificationDropdownItem extends StatefulWidget {
  ...
  @override
  State<AcademicQualificationDropdownItem> createState() => _AcademicQualificationDropdownItemState();
}

class _AcademicQualificationDropdownItemState extends State<AcademicQualificationDropdownItem> {
      ...
      child: Theme(
        ...
        child: DropdownSearch<AcademicQualification>(
          ...
          onChanged: (Object? object) {
             AcademicQualification qualification = object as AcademicQualification;
            setState(() {
          ...
          selectedItem: value != '' && academicQualificationList.isNotEmpty
              ? academicQualificationList[
                  academicQualificationList.indexWhere((f) => f.qualification == value)]
              : null,
          showSearchBox: false,
  ...
  void _getAcademicQualificationData() async {
    List<AcademicQualification> statusList = List<AcademicQualification>.from(
        (await DBUtils.getEmployerConfigs('academic_qualification_types'))
