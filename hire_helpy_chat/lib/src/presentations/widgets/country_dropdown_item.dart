...
class _CountryDropdownItemState extends State<CountryDropdownItem> {
  ...
  Widget _customPopupItemBuilder(
    ...
    return item.name == 'Others' || item.name == 'ANY'
        ? _getAnyCountry(
            item.name ?? '', AppColors.black.withOpacity(0.7), 18.0, 10.0)
        : Padding(
            padding:
  ...
  Widget _customDropdownBuilder(
    ...
    return item.name == 'Others' || item.name == 'ANY'
        ? _getAnyCountry(
            item.name ?? '', AppColors.black.withOpacity(0.7), 10.0, 0.0)
        : Row(
            children: [
              EmployerFlag(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: (widget.hasColouredBorder ?? false)
  ...
  _getAnyCountry(String text, Color textColor, double padding, double margin) =>
      Row(
        children: [
          Padding(
            padding:
