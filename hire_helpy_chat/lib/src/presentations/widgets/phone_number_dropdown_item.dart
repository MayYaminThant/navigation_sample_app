...
class _PhoneNumberDropdownItemState extends State<PhoneNumberDropdownItem> {
  ...
  void didUpdateWidget(covariant PhoneNumberDropdownItem oldWidget) {
    if (widget.initialValue != '' &&
      ...
      widget.onValueChanged(countryList[
          countryList.indexWhere((f) => widget.isCallCode? f.dialCode== widget.initialValue :f.name == widget.initialValue)]);
    }
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: AssetImage(item.flagUri), fit: BoxFit.cover)),
                ),
                Padding(
  ...
  Widget _customDropDownButton(BuildContext context) {
    return const Center(
      child: Padding(
        padding:
            EdgeInsets.only(left: 10, bottom: 10, right: 0),
        child: SizedBox(
          width: 10,
          height: 10,
          child: Icon(
      ...
      child: Theme(
        ...
        child: DropdownSearch<Country>(
          ...
          selectedItem: value != '' && countryList.isNotEmpty
              ? countryList[countryList.indexWhere((f) => widget.isCallCode? f.dialCode == value : f.name == value)]
              : null,
          showSearchBox: true,
