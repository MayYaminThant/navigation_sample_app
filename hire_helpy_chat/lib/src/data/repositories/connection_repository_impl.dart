...
class ConnectionRepositoryImpl implements ConnectionRepository {
  ...
  @override
  Future<DataState<DataResponseModel>> createAcceptRequests(ConnectionAcceptRequestParams params) async{
    try {
  ...
  @override
  Future<DataState<DataResponseModel>> createRejectRequests(ConnectionRejectRequestParams params) async{
    try {
  ...
  @override
  Future<DataState<DataResponseModel>> createSendRequest(ConnectionSendRequestParams params) async{
    try {
  ...
  @override
  Future<DataState<DataResponseModel>> getIncomingRequests(ConnectionIncomingRequestParams params) async{
    try {
  ...
  @override
  Future<DataState<DataResponseModel>> getMyRequests(ConnectionGetMyRequestParams params) async{
    try {
  ...
  @override
  Future<DataState<DataResponseModel>> deleteMyRequests(ConnectionCancelRequestParams params) async{
     try {
  ...
  @override
  Future<DataState<DataResponseModel>> connectionList(ConnectionListRequestParams params) async{
   try {
  ...
  //Connection Unlink
  @override
  Future<DataState<DataResponseModel>> connectionUnlink(ConnectionUnlinkRequestParams params) async{
    try {
