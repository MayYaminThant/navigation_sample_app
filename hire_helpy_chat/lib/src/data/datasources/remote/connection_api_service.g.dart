  ...
  Future<HttpResponse<DataResponseModel>> createSendequest({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      contentType: 'application/x-www-form-urlencoded',
            ...
            .compose(
              _dio.options,
              '/employer/connections/send_request',
  ...
  Future<HttpResponse<DataResponseModel>> getMyRequests({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/employer/connections/my_requests',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<HttpResponse<DataResponseModel>> getIncomingsRequests({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/employer/connections/incomings',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<HttpResponse<DataResponseModel>> deleteMyRequest({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      contentType: 'application/x-www-form-urlencoded',
            ...
            .compose(
              _dio.options,
              '/employer/connections/my_requests/${chatRequestId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<HttpResponse<DataResponseModel>> unlinkConnection({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/employer/connections/unlink/${chatConnectId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
